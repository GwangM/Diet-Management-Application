...
import com.fDiary.server.oauth.model.BodyInfoDto;
...
public class MemberController {
    ...
    @PostMapping("/setBodyInfo")
    public ResponseEntity<?> setBodyInfo(@RequestBody BodyInfoDto dto){
        String userId = SecurityUtil.getCurrentUsername();
        memberService.setBodyInfo(userId,dto);
        Map<String,String> result = new HashMap<>();
        result.put("result", "success");
        return ResponseEntity.ok(result);
    }
